...
#!/bin/bash
ans=$(bitcoin-cli verifymessage 1E9YwDtYf9R29ekNAfbV7MvB4LNv7v3fGa HCsBcgB+Wcm8kOGMH8IpNeg0H4gjCrlqwDf/GlSXphZGBYxm0QkKEPhh9DTJRp2IDNUhVr0FhP9qCqo2W0recNM= 1E9YwDtYf9R29ekNAfbV7MvB4LNv7v3fGa)
echo $ans
